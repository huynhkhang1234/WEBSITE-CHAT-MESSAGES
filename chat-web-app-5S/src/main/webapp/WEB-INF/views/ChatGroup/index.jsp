...
<head>
	...
	<link rel="stylesheet" href="<c:url value="/static/dist/css/Styles.css" />"
</head>
...
<body style="font-family: 'Times New Roman', Times, serif">
				...
				<div class="container">
					<div class="inside">
						...
						<%-- src="<c:url value="/static/images/anh1.jpg" />"  --%>
							<button class="btn">
							<img class="avatar-xl" src="<c:url value="/static/dist/img/avatars/avatar-male-1.jpg"  />" 
									alt="avatar"></button>
							<a href="#members" onclick="toggleSidebar()" data-toggle="tab"><i
									class="material-icons">account_circle</i></a>
							<a href="#discussions" onclick="toggleSidebar()" data-toggle="tab" class="active"><i
									class="material-icons active">chat_bubble_outline</i></a>
							<a href="#notifications" onclick="toggleSidebar()" data-toggle="tab" class="f-grow1"><i
									class="material-icons">notifications_none</i></a>
							<button class="btn create" data-toggle="modal" data-target="#AddGroupModal"><a href="#Group"
									data-toggle="tab"><i class="material-icons">group_add</i></a></button>
							<input type="checkbox" id="darkModeToggle" hidden>
							<label for="darkModeToggle"><i class="material-icons">brightness_2</i></label>
					...
					<div class="col-md-12">
						<div class="tab-content">
								...
								<div class="contacts">
									...
									<div class="list-group" id="contacts" role="tablist">
										<a href="#" class="filterMembers all online contact" data-toggle="list">
											<img class="avatar-md" src="<c:url value="/static/dist/img/avatars/avatar-male-1.jpg"  />" 
										...
										<a href="#" class="filterMembers all online contact" data-toggle="list">
											...
											<div class="data">
												<h5>Bảo Khang</h5>
												<p>Đồng Tháp, Việt nam</p>
											</div>

										</a>
										<a href="#" class="filterMembers all online contact" data-toggle="list">
											<img class="avatar-md" src="<c:url value="/static/dist/img/avatars/avatar-female-2.jpg" />"
											...
											<div class="data">
												<h5>Ngọc Chăm</h5>
												<p>Hậu Giang, Việt Nam</p>
											</div>

										</a>
										<a href="#" class="filterMembers all online contact" data-toggle="list">
											<img class="avatar-md" src="<c:url value="/static/dist/img/avatars/avatar-male-2.jpg" />"
								...
								<div class="discussions">
									...
									<div class="list-group" id="chats" role="tablist">
										<a href="#list-chat" class="filterDiscussions all unread single active"
											...
											<img class="avatar-md" src="<c:url value="/static/dist/img/avatars/avatar-female-1.jpg" />"
												data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
											<div class="status">
												<i class="material-icons online">fiber_manual_record</i>
											</div>
										...
										<a href="#list-empty" class="filterDiscussions all unread single"
											...
											<div class="data">
												<h5>Bảo Khang</h5>
												<span>Sun</span>
												<p>Phần mềm đã hoàn thiện giao diện mọi người...</p>
											</div>
										</a>
										<a href="#list-chat" class="filterDiscussions all read single"
											...
											<div class="data">
												<h5>Ngọc Chăm</h5>
												<span>Tus</span>
												<p>Cuối tuần báo cáo tiến độ công việc...</p>
											</div>
										</a>
										<a href="#list-empty" class="filterDiscussions all read single"
											...
											<div class="data">
												<h5>Hồng Phương</h5>
												<span>5 mins</span>
												<p>Font end có bug dòng 75, team vào check nhé...</p>
											</div>
										</a>
										<a href="#list-chat" class="filterDiscussions all read single"
											id="list-chat-list3" data-toggle="list" role="tab">
											<img class="avatar-md" src="<c:url value="/static/dist/img/avatars/avatar-female-3.jpg" />"
											...
											<div class="data">
												<h5>Phú Trọng</h5>
												<span>Feb 9</span>
												<p>Nay tôi off buổi chiều nha mn.</p>
											</div>
										</a>
										<a href="#list-empty" class="filterDiscussions all read single"
											id="list-empty-list3" data-toggle="list" role="tab">
											<img class="avatar-md" src="<c:url value="/static/dist/img/avatars/avatar-female-5.jpg" />"
										...
										<a href="#list-request" class="filterDiscussions all unread single"
											...
											<img class="avatar-md" src="<c:url value="/static/dist/img/avatars/avatar-female-6.jpg" />"
										...
										<a href="#list-empty" class="filterDiscussions all read single"
											...
											<img class="avatar-md" src="<c:url value="/static/dist/img/avatars/avatar-male-3.jpg" />"
										...
										<a href="#list-chat" class="filterDiscussions all unread single"
											...
											<img class="avatar-md" src="<c:url value="/static/dist/img/avatars/avatar-male-4.jpg" />"
							...
							<div class="tab-pane fade" id="settings">
								<div class="settings">
									<div class="profile">
										<img class="avatar-xl" src="<c:url value="/static/dist/img/avatars/avatar-male-1.jpg" />" alt="avatar">
										<h1><a href="#">Bảo Khang</a></h1>
									...
									<div class="categories" id="accordionSettings">
												...
												<div class="content">
													<div class="upload">
														<div class="data">
															...
															<label>
																<input type="file">
																<span class="btn button">Tải hình đại diện</span>
															</label>
														</div>
														<p>Để có kết quả tốt nhất, hãy sử dụng hình ảnh có kích thước
															tối thiểu 256px x 256px ở định dạng .jpg hoặc .png!</p>
													</div>
													<form>
														<div class="parent">
															<div class="field">
										...
										<div class="category">
											...
											<div class="collapse" id="collapseTwo" aria-labelledby="headingTwo"
												...
												<div class="content layer">
													<div class="history">
														<p>Khi bạn xóa lịch sử cuộc trò chuyện, tin nhắn sẽ bị xóa khỏi
															thiết bị của bạn.</p>
														<p>Tin nhắn sẽ không bị xóa trên thiết bị của những người mà bạn
															đã trò chuyện cùng.</p>
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="same-address">
															<label class="custom-control-label" for="same-address">Ẩn sẽ
																xóa lịch sử trò chuyện của bạn khỏi danh sách gần
																đây.</label>
														</div>
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="save-info">
															<label class="custom-control-label" for="save-info">Xóa sẽ
																xóa lịch sử trò chuyện của bạn khỏi thiết bị.</label>
														</div>
												...
												<div class="content no-layer">
													<div class="set">
														<div class="details">
															...
															<p>Bạn có thể thiết lập Vuốt để nhận thông báo khi có tin
																nhắn mới.</p>
														</div>
														<label class="switch">
													...
													<div class="set">
														<div class="details">
															...
															<p>Nếu được bật, biểu tượng ứng dụng Vuốt sẽ hiển thị huy
																hiệu màu đỏ khi bạn có tin nhắn chưa đọc.</p>
														</div>
														<label class="switch">
															<input type="checkbox" checked>
															<span class="slider round"></span>
													...
													<div class="set">
														<div class="details">
															...
															<p>Thấp nháy ứng dụng Vuốt trên thiết bị di động trên thanh
																tác vụ khi bạn
																có thông báo mới.</p>
														</div>
														<label class="switch">
													...
													<div class="set">
														<div class="details">
															...
															<p>Đặt ứng dụng để cảnh báo bạn qua âm thanh thông báo khi
																bạn
																có tin nhắn chưa đọc.</p>
														</div>
														<label class="switch">
															<input type="checkbox" checked>
															<span class="slider round"></span>
													...
													<div class="set">
														<div class="details">
															<h5>Rung</h5>
															<p>Rung khi nhận tin nhắn mới (Đảm bảo hệ thống
																rung cũng được bật).</p>
														</div>
														<label class="switch">
															<input type="checkbox">
															<span class="slider round"></span>
										...
										<div class="category">
											...
											<div class="collapse" id="collapseFour" aria-labelledby="headingFour"
												...
												<div class="content">
													<div class="app">
														<img src="<c:url value="/static/dist/img/avatars/integrations/slack.svg" alt="app"> />"
													...
													<div class="app">
														<img  src="<c:url value="/static/dist/img/avatars/integrations/dropbox.svg" alt="app"> />"
														<div class="permissions">
															<h5>Dropbox</h5>
													...
													<div class="app">
														<img  src="<c:url value="/static/dist/img/avatars/integrations/drive.svg" alt="app"> />"
														<div class="permissions">
															<h5>Google Drive</h5>
															<p>Chưa đặt quyền</p>
														</div>
													...
													<div class="app">
														<img  src="<c:url value="/static/dist/img/avatars/integrations/trello.svg" alt="app"> />"
														<div class="permissions">
															<h5>Trello</h5>
															<p>Chưa đặt quyền</p>
														</div>
										...
										<div class="category">
											...
											<div class="collapse" id="collapseSix" aria-labelledby="headingSix"
												...
												<div class="content layer">
													<div class="language">
														<label for="country">Ngôn ngữ</label>
												...
												<div class="content no-layer">
													<div class="set">
														<div class="details">
															...
															<p>Tự động quét và xóa tin nhắn trực tiếp bạn nhận được
																từ tất cả những người có chứa nội dung tục tĩu.</p>
														</div>
														<label class="switch">
															<input type="checkbox">
															<span class="slider round"></span>
													...
													<div class="set">
														<div class="details">
															...
															<p>Nếu được bật, sẽ quét tin nhắn trực tiếp từ mọi người trừ
																khi
																họ được liệt kê là bạn của bạn.</p>
														</div>
														<label class="switch">
															<input type="checkbox" checked>
															<span class="slider round"></span>
													...
													<div class="set">
														<div class="details">
															...
															<p>Nếu cho phép bất kỳ ai vào hoặc ra khỏi danh sách bạn bè
																của bạn
																có thể gửi cho bạn lời mời kết bạn.</p>
														</div>
														<label class="switch">
															<input type="checkbox" checked>
															<span class="slider round"></span>
													...
													<div class="set">
														<div class="details">
															<h5>Bạn của bạn</h5>
															<p>Chỉ bạn bè hoặc bạn chung của bạn mới có thể
																gửi cho bạn lời mời kết bạn.</p>
														</div>
														<label class="switch">
															<input type="checkbox" checked>
															<span class="slider round"></span>
													...
													<div class="set">
														<div class="details">
															...
															<p>Cài đặt này cho phép chúng tôi sử dụng và xử lý thông tin
																cho mục đích phân tích.</p>
														</div>
														<label class="switch">
															<input type="checkbox">
															<span class="slider round"></span>
													...
													<div class="set">
														<div class="details">
															...
															<p>Cài đặt này cho phép chúng tôi sử dụng thông tin của bạn
																để
																tùy chỉnh Vuốt cho bạn.</p>
														</div>
														<label class="switch">
															<input type="checkbox">
															<span class="slider round"></span>
				...
				<div class="tab-content" id="nav-tabContent">
					...
					<div class="babble tab-pane fade active show" id="list-chat" role="tabpanel"
									...
									<div class="col-md-12">
										<div class="inside">
											<a href="#"><img class="avatar-md"
													 src="<c:url value="/static/dist/img/avatars/avatar-female-5.jpg" />" data-toggle="tooltip"
											...
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<button class="dropdown-item connect" name="1"><i
															class="material-icons">phone_in_talk</i>Cuộc gọi
														thoại</button>
													<button class="dropdown-item connect" name="1"><i
															class="material-icons">videocam</i>Cuộc gọi video</button>
													<hr>
													<button class="dropdown-item"><i class="material-icons">clear</i>Xóa
														lịch sử</button>
													<button class="dropdown-item"><i
															class="material-icons">block</i>Chặn liên hệ</button>
													<button class="dropdown-item"><i
															class="material-icons">delete</i>Xóa liên lạc</button>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="content" id="content">
								<div class="container">
									<div class="col-md-12">
										...
										<!-- đây là người khác chat cho mình -->
										<div class="message">
										
											<div class="text-main">
												<div class="text-group">
													<div class="text">
														<p>Chúng tôi đã có một số ý tưởng tuyệt vời đang được triển
															khai.</p>
													</div>
												</div>
												<span>09:46 AM</span>
										...
										<!-- End đây là người khác chat cho mình -->
										...
										<div class="message me">
											<div class="text-main">
												<div class="text-group me">
													<div class="text me">
														<p>Không thể chờ đợi được nữa! Chúng ta hợp tác với khách hàng
															như thế nào?</p>
													</div>
												</div>
												<span>11:32 AM</span>
										...
										<div class="message">
											...
											<div class="text-main">
												<div class="text-group">
													<div class="text">
														<p>Mọi việc suôn sẻ, chúng tôi đã có một bản nháp cho khách hàng
															mỏ đá đã hoàn thành.</p>
													</div>
												</div>
												<span>02:56 PM</span>
											</div>
										...
										<div class="message me">
											<div class="text-main">
												...
												<div class="text-group me">
													<div class="text me">
														<p>Tôi đã bắt đầu thu thập vài thứ cho tâm trạng rồi
															bảng, vui mừng bắt đầu!</p>
													</div>
												</div>
												<span>10:21 PM</span>
											</div>
										...
										<div class="message">
											...
											<div class="text-main">
												<div class="text-group">
													<div class="text">
														<p>Khởi đầu tuyệt vời các bạn ạ, tôi đã thêm một số ghi chú vào
															nhiệm vụ. Chúng ta có thể
															cần thực hiện một số điều chỉnh đối với một số mục cuối cùng
															-
															nhưng không có vấn đề gì!</p>
													</div>
												</div>
												<span>11:07 PM</span>
											</div>
										...
										<div class="message me">
											<div class="text-main">
												<div class="text-group me">
													<div class="text me">
														<p>Làm tốt lắm. Hẹn gặp tất cả các bạn lúc 2 giờ trong cuộc họp
															khởi động.</p>
													</div>
												</div>
												<span>10:21 PM</span>
										...
										<div class="message me">
											<div class="text-main">
												<div class="text-group me">
													<div class="text me">
														<p>Hy vọng tất cả các bạn đã sẵn sàng thực hiện dự án tuyệt vời
															này. Hãy
															đập tan một số Ý tưởng và Thiết kế Thương hiệu!</p>
													</div>
												</div>
						...
						<div class="modal fade" id="AddGroupModal" tabindex="-1" role="dialog" aria-hidden="true">
							<div class="modal-dialog modal-lg modal-dialog-centered" style="width: 900px!important;"
								role="document">
								<div class="requests">
									<div class="title">
										<h1>Tạo nhóm</h1>
									...
									<div class="content">
										...
										<form><!--<span class="material-icons">
									photo_camera
									</span> <div class="row"-->
											...
											<div class="input-group ">
												...
												<div class="col col-lg-2 ">
													<!--ANH Nhom-->
													<button class="btn" data-toggle="modal" data-target="#ModalAnh"><img
															class="avatar-xl" src="dist/img/avatars/Photo.png"
															alt="avatar"></button>
													<!-- Hiển thị ảnh đã chọn
						<img id="selectedImage" src="#" alt="Ảnh đã chọn" style="display: none;"> -->
												</div>
												<div class="form-group col ">
													<label for="searchInput" class="sr-only">TenNhom</label>
													<input type="text" class="form-control search-input " id="TenNhom"
											...
											<div class="form-group ">
												<label for="user">Thêm bạn vào nhóm:</label>
											...
											<p style="color: black;">Số lượng đã chọn: <span id="count">0</span></p><br>
									...
									height: 40px;
									font-size: 20px;
									background-color: #308bec; " type="submit" class="btn btn-create-group">Tạo nhóm</button>
											</div>
										</form>
									</div>
								</div>
	...
	<script 
	src="<c:url value="/dist/js/jquery-3.3.1.slim.min.js" />" charset="utf-8"
		integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo"
		crossorigin="anonymous"></script>
	<script>window.jQuery || document.write('<script src="<c:url value="/dist/js/vendor/jquery-slim.min.js" />" charset="utf-8"><\/script>')
...
<%-- 	<script src="<c:url value="/static/dist/js/vendor/popper.min.js" />" charset="utf-8"></script>
 <script src="<c:url value="/static/dist/js/swipe.min.js" />" charset="utf-8"></script> 
 <script src="<c:url value="/static/dist/js/bootstrap.min.js" />" charset="utf-8"></script>
 <script src="<c:url value="/static/dist/js/script.js"/>"  charset="utf-8"></script> --%>
		<script>
