...
<body style="font-family: 'Times New Roman', Times, serif">
				...
				<div class="container">
					<div class="inside">
						<div class="nav nav-tab menu">
							<button class="btn"><img class="avatar-xl" src="<c:url value="/static/dist/img/avatars/avatar-male-1.jpg"  />" 
									alt="avatar"></button>
							<a  href="#members" onclick="toggleSidebar()" class="modal" data-toggle="tab"><i
			...
			<div class="main">
				<div class="tab-content" id="nav-tabContent">
					...
					<div class="babble tab-pane fade active show" id="list-chat" role="tabpanel"
						...
						<!--END MODAL ADD GROUP-->
						<!-- MODAL CHON ANH-->
						<div class="modal fade" id="ModalAnh" tabindex="-1" role="dialog" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="requests">
									<div class="title">
									...
									<div class="content">
										...
										<div class="container ">
											...
											<button style="background-color: rgb(154, 225, 248); color: blue;"
												type="submit" class="btn button w-100" onclick="openFileExplorer()"><i
													class="material-icons">
													image
												</i> Tải lên từ máy tính</button>
	...
	<script>window.jQuery || document.write('<script src="dist/js/vendor/jquery-slim.min.js"><\/script>')
