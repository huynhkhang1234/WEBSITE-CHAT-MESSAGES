...
<body>
	<main>
		<div class="layout">
				...
				<div class="container">
					<div class="inside">
						<div class="nav nav-tab menu">
							<button class="btn">
								<img class="avatar-xl"
									src="/static/dist/img/avatars/avatar-male-1.jpg" alt="avatar">
							</button>
							<a href="#members" data-toggle="tab"><i
								class="material-icons">account_circle</i></a> <a href="#discussions"
								data-toggle="tab" class="active"><i
								class="material-icons active">chat_bubble_outline</i></a> <a
								href="#notifications" data-toggle="tab" class="f-grow1"><i
								class="material-icons">notifications_none</i></a>
							<button class="btn mode">
								<i class="material-icons">brightness_2</i>
							</button>
							<a href="#settings" data-toggle="tab"><i
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="members">
								...
								<div class="contacts">
									...
									<div class="list-group" id="contacts" role="tablist">
										<!-- link đường dẫn  box c-->
										<a href="#list-empty" class="filterMembers all online contact"
											data-toggle="list"> <img class="avatar-md"
											src="/static/dist/img/avatars/avatar-female-1.jpg"
										...
										</a> <a href="#list-chat" class="filterMembers all online contact"
											data-toggle="list"> <img class="avatar-md"
											src="/static/dist/img/avatars/avatar-male-1.jpg"
											...
											<img class="avatar-md"
											src="/static/dist/img/avatars/avatar-female-2.jpg"
											...
											data-toggle="list"> <img class="avatar-md"
											src="/static/dist/img/avatars/avatar-male-2.jpg"
											...
											class="filterMembers all online contact" data-toggle="list">
											<img class="avatar-md"
											src="/static/dist/img/avatars/avatar-female-3.jpg"
											...
											class="filterMembers all offline contact" data-toggle="list">
											<img class="avatar-md"
											src="/static/dist/img/avatars/avatar-female-5.jpg"
											...
											class="filterMembers all offline contact" data-toggle="list">
											<img class="avatar-md"
											src="/static/dist/img/avatars/avatar-female-6.jpg"
											...
											class="filterMembers all offline contact" data-toggle="list">
											<img class="avatar-md"
											src="/static/dist/img/avatars/avatar-male-3.jpg"
											...
											class="filterMembers all offline contact" data-toggle="list">
											<img class="avatar-md"
											src="/static/dist/img/avatars/avatar-male-4.jpg"
								...
								<div class="discussions">
									...
									<div class="list-group" id="chats" role="tablist">
										...
										<a href="#list-empty"
											...
											id="list-empty-list" data-toggle="list" role="tab"> <img
											class="avatar-md"
											src="/static/dist/img/avatars/avatar-male-1.jpg"
											data-toggle="tooltip" data-placement="top" title="Michael"
											alt="avatar">
											...
											id="list-chat-list2" data-toggle="list" role="tab"> <img
											class="avatar-md" src="/dist/img/avatars/avatar-female-2.jpg"
											data-toggle="tooltip" data-placement="top" title="Lean"
											alt="avatar">
											<div class="status">
												<i class="material-icons offline">fiber_manual_record</i>
											...
											<div class="data">
												<h5>Lean Avent</h5>
												<span>Tus</span>
												<p>Hey Chris, could i ask you to help me out with
													variation...</p>
											</div>
										</a> <a href="#list-empty"
											class="filterDiscussions all read single"
											id="list-empty-list2" data-toggle="list" role="tab"> <img
											class="avatar-md" src="/dist/img/avatars/avatar-male-2.jpg"
											data-toggle="tooltip" data-placement="top" title="Mariette"
											alt="avatar">
											<div class="status">
												<i class="material-icons offline">fiber_manual_record</i>
											...
											class="filterDiscussions all read single"
											id="list-chat-list3" data-toggle="list" role="tab"> <img
											class="avatar-md" src="/dist/img/avatars/avatar-female-3.jpg"
											data-toggle="tooltip" data-placement="top" title="Harmony"
											alt="avatar">
											<div class="status">
												<i class="material-icons online">fiber_manual_record</i>
											...
											class="filterDiscussions all read single"
											id="list-empty-list3" data-toggle="list" role="tab"> <img
											class="avatar-md" src="/dist/img/avatars/avatar-female-5.jpg"
											data-toggle="tooltip" data-placement="top" title="Keith"
											alt="avatar">
											<div class="status">
												<i class="material-icons offline">fiber_manual_record</i>
											...
											<div class="data">
												<h5>Keith Morris</h5>
												<span>Fri</span>
												<p>All your favourite books at your reach! We are now
													mobile.</p>
											</div>
										</a> <a href="#list-request"
											class="filterDiscussions all unread single"
											id="list-request-list" data-toggle="list" role="tab"> <img
											class="avatar-md" src="/dist/img/avatars/avatar-female-6.jpg"
											data-toggle="tooltip" data-placement="top" title="Louis"
											alt="avatar">
											<div class="status">
												<i class="material-icons offline">fiber_manual_record</i>
											...
											class="filterDiscussions all read single"
											id="list-empty-list4" data-toggle="list" role="tab"> <img
											class="avatar-md" src="/dist/img/avatars/avatar-male-3.jpg"
											data-toggle="tooltip" data-placement="top" title="Ryan"
											alt="avatar">
											<div class="status">
												<i class="material-icons offline">fiber_manual_record</i>
											...
											class="filterDiscussions all unread single"
											id="list-chat-list5" data-toggle="list" role="tab"> <img
											class="avatar-md" src="/dist/img/avatars/avatar-male-4.jpg"
											data-toggle="tooltip" data-placement="top" title="Mildred"
											alt="avatar">
											<div class="status">
												<i class="material-icons offline">fiber_manual_record</i>
								...
								<div class="notifications">
									...
									<div class="list-group" id="alerts" role="tablist">
										<a href="#list-empty"
											...
											class="filterNotifications all oldest notification"
											data-toggle="list"> <img class="avatar-md"
							...
							<div class="tab-pane fade" id="settings">
								<div class="settings">
									<div class="profile">
										<img class="avatar-xl"
											src="/dist/img/avatars/avatar-male-1.jpg" alt="avatar">
										<h1>
											<a href="#">NO Hope Mute Coment</a>
										</h1>
										<span>Mute Coment</span>
										<div class="stats">
											<!-- <div class="item">
													<h2>122</h2>
													<h3>Fellas</h3>
									...
									<div class="categories" id="accordionSettings">
										...
										<div class="category">
											<a href="#" class="title collapsed" id="headingOne"
												...
												<div class="data">
													...
													<p>Chỉnh sửa tài khoản của bạn</p>
											...
											<div class="collapse" id="collapseOne"
												...
												<div class="content">
													<div class="upload">
														<div class="data">
															<img class="avatar-xl"
																src="/dist/img/avatars/avatar/.jpg" alt="image"> <label>
																<input type="file" id="imageInput" accept=".jpg, .png"
																onchange="displaySelectedImage(event)"> <span
																class="btn button">Tải Hình Của Bạn Lên</span>
															</label>
														</div>
													...
													<form>
														<div class="parent">
															<div class="field">
																<label for="firstName">Tên Người Dùng <span>*</span></label>
														...
														<!-- <div class="field">
																<label for="email">Tài Khoản Email <span>*</span></label>
																<input type="email" class="form-control" id="email" placeholder="Hãy Nhập Email Của Bạn" value="" required>
															</div> -->
														<div class="field">
															<label for="password">Mật Khẩu</label> <input
																type="password" class="form-control" id="password"
																placeholder="Hãy Nhập Password Của Bạn " value=""
																required>
														</div>
														<!-- <div class="field">
														...
														<button type="submit" class="btn button w-100">Xác
															Nhận</button>
													</form>
												</div>
											</div>
										...
										<div class="category">
											...
											<div class="collapse" id="collapseTwo"
												...
												<div class="content layer">
													<div class="history">
														<p>When you clear your conversation history, the
															messages will be deleted from your own device.</p>
														<p>The messages won't be deleted or cleared on the
															devices of the people you chatted with.</p>
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="same-address"> <label
																class="custom-control-label" for="same-address">Hide
																will remove your chat history from the recent list.</label>
														</div>
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="save-info"> <label
																class="custom-control-label" for="save-info">Delete
												...
												<div class="content no-layer">
													<div class="set">
														<div class="details">
															...
															<p>You can set up Swipe to receive notifications when
													...
													<div class="set">
														<div class="details">
															...
															<p>If enabled shows a red badge on the Swipe app icon
													...
													<div class="set">
														<div class="details">
															...
															<p>Flashes the Swipe app on mobile in your taskbar
																when you have new notifications.</p>
														</div>
														<label class="switch"> <input type="checkbox">
													...
													<div class="set">
														<div class="details">
															...
															<p>Set the app to alert you via notification sound
																when you have unread messages.</p>
														</div>
														<label class="switch"> <input type="checkbox"
															checked> <span class="slider round"></span>
													...
													<div class="set">
														<div class="details">
															...
															<p>When someone send you a text message you will
																receive alert via notification light.</p>
														</div>
														<label class="switch"> <input type="checkbox">
															<span class="slider round"></span>
														</label>
										...
										<div class="category">
											<a href="#" class="title collapsed" id="headingFive"
												...
												class="material-icons md-30 online">colorize</i>
												<div class="data">
													<h5>Appearance</h5>
										...
										<div class="category">
											...
											<div class="collapse" id="collapseSix"
												...
												<div class="content layer">
													<div class="language">
														<label for="country">Language</label> <select
												...
												<div class="content no-layer">
													<div class="set">
														<div class="details">
															...
															<p>Automatically scan and delete direct messages you
																receive from everyone that contain explict content.</p>
														</div>
														<label class="switch"> <input type="checkbox">
															<span class="slider round"></span>
														</label>
													...
													<div class="set">
														<div class="details">
															...
															<p>If enabled scans direct messages from everyone
																unless they are listed as your friend.</p>
														</div>
														<label class="switch"> <input type="checkbox"
															checked> <span class="slider round"></span>
														</label>
													...
													<div class="set">
														<div class="details">
															...
															<p>If enabled anyone in or out your friends of
																friends list can send you a friend request.</p>
														</div>
														<label class="switch"> <input type="checkbox"
															checked> <span class="slider round"></span>
														</label>
													...
													<div class="set">
														<div class="details">
															...
															<p>Only your friends or your mutual friends will be
																able to send you a friend reuqest.</p>
														</div>
														<label class="switch"> <input type="checkbox"
															checked> <span class="slider round"></span>
														</label>
													...
													<div class="set">
														<div class="details">
															...
															<p>This settings allows us to use and process
							...
							<form>
								<div class="form-group">
									<label for="user">Username:</label> <input type="text"
										class="form-control" id="user" placeholder="Add recipient..."
										required>
								...
								<button type="submit" class="btn button w-100">Send
			...
			<div class="modal fade" id="startnewchat" tabindex="-1" role="dialog"
				aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="requests">
						<div class="title">
						...
						<div class="content">
							<form>
								<div class="form-group">
									<label for="participant">Recipient:</label> <input type="text"
										class="form-control" id="participant"
								...
								<button type="submit" class="btn button w-100">Start
									New Chat</button>
							</form>
						</div>
					</div>
									...
									<div class="col-md-12">
										...
										<div class="message me">
											<div class="text-main">
												<div class="text-group me">
													<div class="text me">
														<p>Can't wait! How are we coming along with the
															client?</p>
													</div>
												</div>
												<span>11:32 AM</span>
										...
										<div class="message me">
											<div class="text-main">
												...
												<div class="text-group me">
													<div class="text me">
														<p>I have already started gathering some stuff for the
															mood boards, excited to start!</p>
													</div>
												</div>
												<span>10:21 PM</span>
											</div>
										...
										<div class="message me">
											<div class="text-main">
												<div class="text-group me">
													<div class="text me">
														<p>Well done all. See you all at 2 for the kick-off
															meeting.</p>
													</div>
												</div>
												<span>10:21 PM</span>
										...
										<div class="message me">
											<div class="text-main">
												<div class="text-group me">
													<div class="text me">
														<p>Hope you're all ready to tackle this great project.
															Let's smash some Brand Concept & Design!</p>
													</div>
												</div>
